...
import ReceiptCashflow from './ReceiptCashflow';
import ExpenditureCashflow from './ExpenditureCashflow';

export default function CombineCashflow() {
    ...
    return (
        <div className="min-h-screen bg-white px-6 py-8">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div>
                    {activeTab === 'receipt' && <ReceiptCashflow />}
                    {activeTab === 'expenditure' && <ExpenditureCashflow />}
                </div>
            </div>
        </div>
    );
